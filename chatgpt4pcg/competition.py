...
# Configure LM Studio local API
openai.api_key = "lm-studio"
openai.api_base = "http://localhost:1234/v1"

def chat_with_chatgpt(ctx, messages, n=1):
    """
    Call LM Studio's chat interface
    """
    model = "qwen2.5-coder-32b-instruct"  # Replace with your model identifier
    temperature = 1.0
    max_tokens = 512
